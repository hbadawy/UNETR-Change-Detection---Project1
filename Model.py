...
################FORWARD PASS################
    ...
    def forward(self, m, n):
        ...
        print ("patch_embed1 shape: " , patch_embed1.shape)
...
if __name__ == "__main__":
    ...
    m = torch.rand((8, 256, 768), dtype=torch.float32)
    n = torch.rand((8, 256, 768), dtype=torch.float32)
    f = UNETR_2D_CD(config, device=device)
    out = f(m,n)
    print("MODEL OUTPUT SHAPE",out.shape, "MODEL OUTPUT TYPE", out.dtype)
